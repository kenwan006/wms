<template>
  <div>
    <div style="margin-bottom: 5px;">
      <el-input v-model="name" placeholder="Please enter type name" suffix-icon="el-icon-search" style="width: 200px;"
...
export default {
  ...
  methods: {
    ...
    del(id) {
      ...
      this.$axios.get(this.$httpUrl + '/wms/goodstype/del?id=' + id).then(res => res.data).then(res => {
        console.log(res)
        if (res.code == 200) {
    ...
    doSave() {
      this.$axios.post(this.$httpUrl + '/wms/goodstype/save', this.form).then(res => res.data).then(res => {
        console.log(res)
        if (res.code == 200) {
    ...
    doMod() {
      this.$axios.post(this.$httpUrl + '/wms/goodstype/update', this.form).then(res => res.data).then(res => {
        console.log(res)
        if (res.code == 200) {
    ...
    loadPost() {
      this.$axios.post(this.$httpUrl + '/wms/goodstype/listPage', {
